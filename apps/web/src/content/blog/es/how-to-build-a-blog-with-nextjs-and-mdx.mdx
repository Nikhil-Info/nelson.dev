...
summary: ¡Usar Next.js para construir un blog es muy fácil!
---
...
- [gray-matter](https://github.com/jonschlinkert/gray-matter) analizar el front matter en markdown
...
- `components/layout.jsx` - Envuelve todos los componentes en un contenedor (opcional, solo para el estilo)
- `date/blog/*.mdx` - Artículos del blog
- `lib/format-date.js` - Formatea la fecha como `DD de Mes de AAAA`
- `pages/blog/[slug].jsx` - página de artículo, usando [rutas dinámicas](https://nextjs.org/docs/pages/building-your-application/routing/dynamic-routes)
...
Luego escribe una función para eliminar la extensión del archivo, que se usará más tarde.
...
export const getPostBySlug = async (slug) => {
  ...
  // Poner contenido para serializar (next-mdx-remote) para manejar

  const frontMatter = {
    ...data,
    slug
  }
  // Poner el slug en el front matter también, que se usará más tarde
...
Luego puedes obtener todos los artículos para mostrar en la página de inicio.
...
De esta manera, un blog simple está terminado.
